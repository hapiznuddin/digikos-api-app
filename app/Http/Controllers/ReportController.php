...
class ReportController extends Controller
{
    ...
    $reportIncome = $incomeQuery
        ->selectRaw('COUNT(*) as total_payment, SUM(price) as total_price, MONTHNAME(created_at) as month_name, YEAR(created_at) as year_name')
        ->groupByRaw('YEAR(created_at), MONTHNAME(created_at)')
        ->get();

    $reportExpense = $expenseQuery
        ->selectRaw('COUNT(*) as total_expense, SUM(total_payment) as total_price, MONTHNAME(date_paid) as month_name, YEAR(date_paid) as year_name')
